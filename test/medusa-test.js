...
describe('Medusa', function () {
  ...
  //   console.log("This is the victim:" + victim4.stoned);
  //   assert(!victim1.stoned);
  //   });
  // });
  ...
  it.only('should unstone the the first victim and stone the 4th coming in', function() {
    ...
    var medusa = new Medusa('Meeka');
    // create first victim
    var victim1 = new Person('Laura');
    // create second victim
    var victim2 = new Person('Bob');
    // create third victim
    var victim3 = new Person('Tim');
    // create fourth victim
    var victim4 = new Person('Lisa');
    ...
    medusa.stare(victim2);
    medusa.stare(victim2.stoned, true)
    // medusa stares at third victim
    medusa.stare(victim3);
    medusa.stare(victim3.stoned, true);
    // medusa stares at fourth victim
    medusa.stare(victim4);
    // assert the fourth victim is stone22d
