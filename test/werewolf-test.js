...
describe('Werewolf', function () {
  ...
  it.skip('should start off not hungry', function() {
    var werewolf = new Werewolf('Amy', 'Nowhere');
  ...
  it.skip('should be able to eat(victim) once hungry', function() {
    ...
    // console.log("default hunger val:" + werewolf.hungry);
    ...
    // console.log("hunger VAL AFTER CHANGE: " + werewolf.hungry);

    // console.log("victim default value: " + victim.alive);

  
    // console.log("victim after eaten: " + victim.alive);
    
  });

  it('should not be hungry after changing back to human form', function() {

    var werewolf = new Werewolf('Bob', 'Canada');

    var human = new Victim('Aria');
